...
extension Mood {
    static let all: [Mood] = [
        Mood(nameKey: "mood_energetic",  nameTr: "Enerjik",   nameEn: "Energetic",   emoji: "⚡️", color: Color(hex: "C44F35")),
        Mood(nameKey: "mood_calm",       nameTr: "Sakin",     nameEn: "Calm",        emoji: "🌊", color: Color(hex: "2F7773")),
        Mood(nameKey: "mood_focused",    nameTr: "Odaklı",    nameEn: "Focused",     emoji: "🎯", color: Color(hex: "4E5D78")),
        Mood(nameKey: "mood_happy",      nameTr: "Mutlu",     nameEn: "Happy",       emoji: "😊", color: Color(hex: "B98725")),
        Mood(nameKey: "mood_sad",        nameTr: "Hüzünlü",   nameEn: "Melancholic", emoji: "🌧", color: Color(hex: "66717E")),
        Mood(nameKey: "mood_romantic",   nameTr: "Romantik",  nameEn: "Romantic",    emoji: "🌹", color: Color(hex: "A94752")),
        Mood(nameKey: "mood_motivated",  nameTr: "Motive",    nameEn: "Motivated",   emoji: "🚀", color: Color(hex: "3E7654")),
        Mood(nameKey: "mood_nostalgic",  nameTr: "Nostaljik", nameEn: "Nostalgic",   emoji: "🎞️", color: Color(hex: "9A654A")),
    ]
}
